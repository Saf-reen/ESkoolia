    ...
    return (
        <section className="relative py-24 pb-32 overflow-hidden bg-white lg:py-32">
            <div className="px-8 md:px-16 lg:px-24 w-full relative z-10">
                ...
                >
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-black uppercase tracking-[0.3em] text-sm mb-4 block">
                        Core Platform
                    </span>
                    ...
                    <motion.div
                        ...
                        className="h-1 bg-gradient-to-r from-purple-600 to-orange-600 mx-auto rounded-full"
                    />
                </motion.div>
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#581C87]/5 text-[#581C87] font-bold text-sm mb-6 uppercase tracking-wider border border-[#581C87]/10">
                                <div className="w-2 h-2 rounded-full bg-gradient-to-r from-purple-600 to-orange-600 animate-pulse" />
                                Unified Ecosystem
                            </div>
                                    ...
                                    <Link to={block.href} className="flex gap-6 group cursor-pointer">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-[#581C87] font-bold text-xl mb-1 tracking-tight inline-block relative">
                                                {block.title}
                                                <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-gradient-to-r from-purple-600 to-orange-600 transition-all duration-300 group-hover:w-full"></span>
                                            </h4>
