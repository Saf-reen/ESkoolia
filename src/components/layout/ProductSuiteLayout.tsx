        ...
        <div className="bg-white min-h-screen">
            ...
            <section className="py-24 lg:py-40 border-b border-gray-50">
                <div className="w-full px-8 md:px-16 lg:px-24 text-center">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-black tracking-[0.3em] uppercase text-xs mb-6 block">{subtitle}</span>
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <Button size="lg" className="h-18 px-14 rounded-full bg-[#581C87] hover:bg-gradient-to-r from-purple-600 to-orange-600 text-white font-black text-xl shadow-2xl uppercase transition-all" asChild>
            ...
            <section className="py-24 lg:py-40 bg-gray-50">
                <div className="w-full px-8 md:px-16 lg:px-24">
                    <div className="text-left mb-20">
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-black tracking-[0.3em] uppercase text-xs mb-4 block">Core Suite features</span>
                ...
                <div className="w-full px-8 md:px-16 lg:px-24">
                    <div className="grid lg:grid-cols-2 gap-24 items-center w-full">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-black tracking-[0.3em] uppercase text-xs mb-6 block">Why Choose Eskoolia</span>
                            ...
                            <div className="space-y-8">
                                {benefits.map((benefit, i) => (
                                    <div key={i} className="flex gap-6 items-start">
                                        <div className="mt-1 h-8 w-8 rounded-full bg-gradient-to-r from-purple-600 to-orange-600 text-white flex items-center justify-center shrink-0 shadow-lg shadow-orange-600/30">
                        ...
                        >
                            <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-r from-purple-600 to-orange-600/10 rounded-bl-full"></div>
                            ...
                            <Button className="h-18 px-14 rounded-full bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-[#581C87] text-white font-black text-xl shadow-2xl shadow-orange-600/20 uppercase transition-all" asChild>
            ...
            <section className="py-32 bg-[#581C87] relative overflow-hidden text-center text-white">
                ...
                <div className="w-full px-8 md:px-16 lg:px-24 relative z-10">
                    <h2 className="font-display text-4xl md:text-7xl font-black mb-12 max-w-6xl mx-auto leading-tight uppercase tracking-tight">Take control of your school <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600">Join Eskoolia TODAY.</span></h2>
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <Button size="lg" className="h-18 px-14 rounded-full bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-white hover:text-[#581C87] text-white font-black text-xl border-none shadow-2xl" asChild>
