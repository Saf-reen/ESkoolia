...
<div class="text-center py-6 px-2">
  ...
  <h1 class="text-2xl font-bold text-[#276221]/80 mb-1">Welcome</h1>
  <h2 class="text-lg text-[#276221]/70 mb-1">To</h2>
  <h1 class="text-2xl font-bold text-[#6f42c1] mb-2">
    eSkoolia Ultimate Education ERP
  </h1>

  <p class="text-[#276221]/70 mb-2 text-sm">
    Ultimate solution for your school to run modern way
  </p>

  <p class="text-[#276221]/70 text-sm">By</p>
  ...
  <div class="text-[#276221]/70 text-sm leading-6 space-y-3 mb-6 px-2">
    <p>
  ...
  <div class="flex justify-center gap-3">
    ...
    <button class="px-5 py-2 bg-white text-[#8B5CF6] border border-[#8B5CF6] font-semibold rounded-full text-[11px] uppercase tracking-wide hover:bg-[#276221]/5 transition-colors">
      Help & Supports
    </button>
  </div>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-6 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-50">
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-6">Database and database user creation on Server</h4>
                             <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                                <li>
                    ...
                    <li>
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-50">
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-6">Upload the package to your host</h4>
                             <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                                <li>
                    ...
                    <li>
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-50">
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-6">Configure eSkoolia with Database credentials</h4>
                             <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                                <li>
                    ...
                    <li>
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-50">
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-6">Adjust the folders Permissions</h4>
                             <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                                <li>
                    ...
                    <li>
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-50">
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-6">Start the installation</h4>
                             <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                                <li>
            ...
            <div class="space-y-4">
                ...
                <div class="p-4 bg-gray-50 rounded-lg inline-block text-center w-full">
                    <h4 class="font-bold mb-2 text-center text-[#276221]/70">Contact Info</h4>
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-none space-y-6">
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">1 & 3. Dashboard</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">At the top menu of left sidebar is Dashboard. There are several view port in dashboard. we can see the number of students, teachers and staff etc. at a glance. Summary of the Income and Expenses is very important for ERP system. After login a user can see the update for that day.</p>                    </li>
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">2. Website</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">From dashboard a user can easily return to own website home page.</p>
                    </li>
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">4. Reports</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">Reports section is very important in this School Management ERP. You can go to report section from all over the system.</p>
                    </li>
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">5. Language</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">eSkoolia delivered to you equipped with different languages : English, Arabic (RTL), French, Dutch, German, Hindi, Italian, Turkish, Russian, Spanish & Portuguese etc. You can also add language with your own customization.</p>
                    </li>
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">6. Notification</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">If Administrators or Teachers set any task for student, then it will automatically send notifications to Teachers, Students (All students or specify class's students) and parents also you can track sent messages.</p>
                    </li>
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">7. Profile</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">The user can see their profile, change their existing password. Logout button at the bottom of this profile section.</p>
                    </li>
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">8. Number of students</h4>
                             <p class="mt-1 mb-6 text-[#276221]/70">The user can see their profile, change their existing password. Logout button at the bottom of this profile section.</p>
                    ...
                    <li>
                             <h4 class="font-bold text-xl text-[#276221]/70 mb-4">1. Dashboard</h4>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Admission Query</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Admission Query</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Select Actions</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Follow up Admission Query</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Visitor</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Complaint</span>
            ...
            </div>` },
            {
             ...
             <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Postal Receive</span>
            ...
            <div class="space-y-6">
                 ...
                 <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Postal Dispatch</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Phone Call</span>
            ...
            <div class="space-y-6">
                 ...
                 <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Admin Setup</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Student Certificate</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Generate Certificate</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student List</span>
                    </li>
                </ol>
            </div>` },
            {
             ...
             <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Student ID Card</span>
            ...
            </div>` },
            {
             ...
             <div class="space-y-6">
                ...
                <img src="/Eskooly/generate_id_card.png" alt="Generate ID Card" class="w-full rounded-lg shadow-md border border-gray-50" />
                 <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Generate ID Card</span>
        ...
        items: [
            {
             ...
             <div class="space-y-6">
                 ...
                 <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Upload Logo</span> 
                        <p class="mt-1">Upload Institution logo</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Change Logo</span> 
                        <p class="mt-1">After uploading Institution logo it will publish</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">General Settings View</span> 
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Upload Form of General Settings</span> 
                        <p class="mt-1">You can update General Settings according to your institution</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Change Currency</span> 
                        <p class="mt-1">You can change currency as your demand. All kind of currency is available in this system.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Change Language</span> 
            ...
            </div>` },
            {
             ...
             <div class="space-y-6">
                  ...
                  <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                     <li>
                         <span class="font-bold text-[#276221]/70">Select Payment Method</span>
                         <p class="mt-1">PayPal and Stripe payment method implemented. You can configuration one of them.</p>
                     </li>
                     <li>
                         <span class="font-bold text-[#276221]/70">Update Payment Method</span>
                     ...
                     <li>
                         <span class="font-bold text-[#276221]/70">Switch Payment Method</span>
                     ...
                     <li>
                         <span class="font-bold text-[#276221]/70">Stripe Payment Method</span>
                         ...
                         <h5 class="font-bold text-[#276221]/70 mt-4 mb-2">Adding Stripe To Your Create Account</h5>
                         <p class="mt-1 mb-2">You will need to add Stripe as a payment gateway option to your Create account.</p>

                         <p class="mt-2 font-semibold text-[#276221]/70">To do this, please follow the steps below:</p>
                         <ul class="list-disc pl-5 mt-2 space-y-1 text-[#276221]/70">
                         ...
                         <h5 class="font-bold text-[#276221]/70 mt-6 mb-2">Testing Stripe With Your Create Website</h5>

                         <p class="mt-2 font-semibold text-[#276221]/70">To get these, please follow the steps below:</p>
                         <ul class="list-disc pl-5 mt-2 space-y-1 text-[#276221]/70">
             ...
             </div>` },
            {
              ...
              <div class="space-y-6">
                  ...
                  <img src="/Eskooly/role-permission.png" alt="Role Permission" class="w-full rounded-lg shadow-md border border-gray-50" />
                   <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                      <li>
                         <span class="font-bold text-[#276221]/70">Role Permission</span>
                         <p class="mt-1">The administrator can add role and assign their permission</p>
                      </li>
                      <li>
                         <span class="font-bold text-[#276221]/70">Select</span>
                      ...
                      <li>
                         <span class="font-bold text-[#276221]/70">Role Permission Assign</span>
                         <div class="mt-1 text-[#276221]/70 space-y-2">
             ...
             </div>` },
            {
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Base Setup</span>
            ...
            },
            {
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Academic Year</span>
            ...
            },
            {
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Session</span>
            ...
            },
            {
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Holiday</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Manage Holiday</span>
            ...
            },
            {
              ...
              <div class="space-y-6">
                ...
                <img src="/Eskooly/sms-settings.png" alt="Sms Settings" class="w-full rounded-lg shadow-md border border-gray-50" />
                 <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Sms Settings</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Sms Configuration</span>
            ...
            },
            {
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Weekend</span>
                        <p class="mt-1">You can edit weekend.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Checked Weekend</span>
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        ...
                        <span class="font-bold text-[#276221]/70">1. Chnage language Phrases</span>
            ...
            },
            {
              ...
              <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-4 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Update System</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Dormitory Rooms</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Select Action</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Dormitory</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Room Type</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Dormitory Report</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-4">
                <h1 class="text-lg font-bold text-[#276221]/70">Transport Route</h1>
                    <p class="font-bold text-[#276221]/70">This module has 3 sections -</p>
                    <ul class="list-disc pl-5 space-y-1 text-[#276221]/70">
                        <li>Routes</li>
                        <li>Vehicles</li>
                        <li>Assign Vehicle</li>
                        <li>Student Transport Report</li>
                    </ul>
                    <p class="text-[#276221]/70">First we will add Routes then add Vehicles then Assign Vehicle on Routes then check Student Transport Report.</p>
                    
                    <div class="space-y-4 mt-4 text-[#276221]/70">
                        <p><span class="font-bold text-[#276221]/70">Routes -</span> Go to Transport > Routes enter Route Title, Fare & click Save button. All the routes can be see right side at this page.</p>
                        ...
                        <p><span class="font-bold text-[#276221]/70">Student Transport Report -</span> Go to Student Information > Student Transport Report here you can view all students list who has availed transport facility.</p>
                    </div>
                </div>
            </div>` },
            {
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Item Category</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Item List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Item Store</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Supplier</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Receive Details</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Item</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Paid and Unpaid Status</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">New Item Receive</span>
                        <p class="mt-1 mb-3">By clicking the new item receive button, easily can add a new item receive.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Purchase Receipt</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Payment</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">New Item Sell</span>
                        <p class="mt-1 mb-3">By clicking the new item sell button, easily can add a new item's sell information.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Item Sell</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Issue a Item</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Book</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Book List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Book Categories</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Member</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Cancel member list</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Issue Books</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Issue or Return Books</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Issued books</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">All notices</span>
                        <p class="mt-1 mb-3">Super admin can see all the notices which is select for.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Add notice</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add notices</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Send email or SMS (Group)</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Send email or SMS (Individual)</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Send email or SMS (Class)</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Email / Sms Log List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Event</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Homework</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Homework list</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Evaluation homework</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Evaluation Date</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Homework Evaluation Report</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Class routine</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Assigned Class routine</span>
                        <p class="mt-1 mb-3">Assigned class for particular day and period are shown on the class routine list.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Create Class routine</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Assigned Subject</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Assigned Subject List</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Assign Subject Create</span>
                        <p class="mt-1 mb-3">For assign subjects list, search by selecting the class and section.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Assign Subject Create</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Assign Class Teacher</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Subject</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Class</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Section</span>
                        <p class="mt-1 mb-3">To add section, the section name should be added.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Select Section</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Class Room</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Time</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Exam</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Exam List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Exam Schedule</span>
                        <p class="mt-1 mb-3">By Clicking the right-top button add exam schedule super admin enter the exam setup schedule page.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Exam Schedule</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search for Set Exam Schedule</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Assign Exam Schedule</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Assigned exam Schedule</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Create Exam Routine</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Mark Register</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">fill up the Marks</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Setup Exam Attendance</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Grade</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Question Group</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Question Bank</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Online Exam</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Publication status</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">View Result</span>
                        <p class="mt-1 mb-3">By just clicking the view result, result will be shown.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Save question</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Result View</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Approve Leave Request</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">View or Edit Leave Details</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">My remaining leave</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Apply leave</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Leave Define</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Leave Type</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Staff List</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Staff</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Profile</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Payroll</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Documents</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Timeline</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Staff Attendance</span>
                        <p class="mt-1 mb-3">To search staff attendance, user needs to select the role and attendance date.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Mark Holiday</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Save Attendance</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Staff Attendance Report</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Payroll Search</span>
                        <p class="mt-1 mb-3">For searching the staff payroll list, just select the role,month and the year.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Staff List</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Generate Payroll</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search payroll Report</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Profit</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Profit List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Income</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Expense</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Income/Expense</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Income/Expense Result</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Chart Of Account</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Payment Method</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Bank Account</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Collect Fees</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Collect Fees</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Fees</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Fees Payment</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Print</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Fees Master</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Fees Assign</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Fees Group</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Fees Type</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Fees Discount</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Fees Discount For Assign</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Fees Carry Forward</span>
                        <p class="mt-1 mb-3">To search the fees carry forward, super admin have to select class name and section.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Previous Session Balance Fees</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Upload content</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Assignment List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Study Material List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Syllabus List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Other Downloads List</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Import Student</span>
                        <p class="mt-1 mb-3">For importing new student, super admin have to click the import student button.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Parents</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Relation With Guardian</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Student</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Download Sample File</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Import</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Bulk Import of Students</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Select Student</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Details</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Sibling Information</span>
                        <p class="mt-1 mb-3">Sibling information is also included in this student detail information page.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Profile</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Edit Student</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Fees</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Document</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Timeline</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Attendance</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Attendance Report</span>
                        <p class="mt-1 mb-3">To search the student attendance report, class, section, month and year should have to select.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Select Student for Report showing</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Student Category</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Add Student Group</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Promote</span>
                        <p class="mt-1 mb-3">To search student promote list, year and class have to select.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">View Academic Performance</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Promote</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Disabled Students</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Report</span>
                        <p class="mt-1 mb-3">To search the student report, have to select the class,section, student type, gender.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Report List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Guardian Reports</span>
                        <p class="mt-1 mb-3">To search the guardian report, have to select the class, section.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Guardian Reports List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student History</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Login Report</span>
                        <p class="mt-1 mb-3">To search the student login report, have to select the class, the current section.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Login Info Report List</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Fees Statement</span>
                        <p class="mt-1 mb-3">For searching the student fees statement report, have to select the class, section, student name.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Fees Statement List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Balance Fees Report</span>
                        <p class="mt-1 mb-3">For searching the student balance fees report, have to select the class, section.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Fees Report List</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Grand Total</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Transaction Report</span>
                        <p class="mt-1 mb-3">For searching the student balance fees report, have to select from from date to date to.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Fees Collection Details</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Income Result</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Expense Result</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Class Report</span>
                        <p class="mt-1 mb-3">For searching the class report, have to select class and it's section name.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Class Report for particular Class and Section</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Statistic of Fees Collection</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Class Routine</span>
                        <p class="mt-1 mb-3">For searching the class routine, have to select class and it's section name.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Class Routine List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Exam Routine</span>
                        <p class="mt-1 mb-3">For searching the exam routine, have to select examination name.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Exam Routine List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Teacher Class Routine Report</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Merit List Report</span>
                        <p class="mt-1 mb-3">To see the particular section of a class, have to select the exam name, class name, section.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Merit List Report</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Online Exam Report</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Tabulation Sheet Report</span>
                        <p class="mt-1 mb-3">You can search tabulation sheet report. Searching fields are Exam type Id, Class, Section and student.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Terminal Report</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Progress Report</span>
                        <p class="mt-1 mb-3">You can search student progress report</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Progress Report List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Student Fine Report</span>
                        <p class="mt-1 mb-3">You can search student fine report form between two date</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Fine Report List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">User Log list</span>
    ...
    },
    {
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Class Routine</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Homework List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Attendance</span>
                        <p class="mt-1 mb-3">Student can search the student attendance.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Attendance Result</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Exam Result</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Online Active Exams</span>
                        <p class="mt-1 mb-3">Which exams are active that are shown here.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Take Exam</span>
                        <p class="mt-1 mb-3">Student can take examination if they want.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Take Online Exam</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Upload Backup</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Full System Backup</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Download</span>
                        <p class="mt-1 mb-3">You can download from here</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Restore</span>
                        <p class="mt-1 mb-3">You can restore your backup</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">Delete</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">All Notice List</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">System Status</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Subject list</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Teacher list</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">All Issued Book List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Transport Route List</span>
                        <p class="mt-1 mb-3">Student can see the transport routes and vehicles.</p>
                    </li>
                    <li>
                        <span class="font-bold text-[#276221]/70">View Info</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Dormitory Room List</span>
        ...
        items: [
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Create Homework</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Update Homework</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Homework Evaluation</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Fees Statement</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Collect Fees Online Via Card</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                   ...
                   <li>
                    <span class="font-bold text-[#276221]/70">Add Parent</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Guardian</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Save Student Data</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Class Routine</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Class Period</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Set Class Routine</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Homework list</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Assign Subject</span>
                    ...
                    <li>
                        <span class="font-bold text-[#276221]/70">Search Assign Subject</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Student assigned Subjects</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Student assigned Teacher List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Transport List</span>
            ...
            <div class="space-y-6">
                ...
                <ol class="list-decimal pl-5 space-y-8 marker:text-[#276221]/70 marker:font-bold">
                    <li>
                        <span class="font-bold text-[#276221]/70">Student Assigned Dormitory</span>
