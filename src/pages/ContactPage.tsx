    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="w-full px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-8 rounded-[32px] shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 hover:shadow-2xl hover:-translate-y-1 transition-all group flex flex-col items-center text-center">
              <div className="h-20 w-20 rounded-full bg-gradient-to-r from-purple-600 to-orange-600/10 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 flex items-center justify-center mb-6 border-4 border-white shadow-sm transition-all group-hover:scale-110">
              ...
              <Button variant="outline" className="rounded-full border-2 border-orange-600 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-bold hover:bg-gradient-to-r from-purple-600 to-orange-600 hover:text-white px-8" asChild>
            ...
            <div className="bg-white p-8 rounded-[32px] shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 hover:shadow-2xl hover:-translate-y-1 transition-all group flex flex-col items-center text-center">
              ...
              <a href="mailto:support@eskoolia.com" className="text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 hover:text-[#581C87] transition-colors tracking-tight">support@eskoolia.com</a>
              <div className="mt-4 px-3 py-1 rounded-full bg-gradient-to-r from-purple-600 to-orange-600/10 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 text-[10px] font-black uppercase tracking-widest">Available 24/7</div>
            </div>
            ...
            <div className="bg-white p-8 rounded-[32px] shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 hover:shadow-2xl hover:-translate-y-1 transition-all group flex flex-col items-center text-center">
              ...
              <div className="flex flex-col gap-1">
                <a href="tel:+919701314138" className="text-xl font-black text-[#581C87] hover:text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 tracking-tight">+91 970-131-4138</a>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h2 className="font-display text-5xl lg:text-6xl font-black text-[#581C87] leading-[1.1] uppercase">
                Send us a <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600">Message</span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="flex items-center gap-5 p-6 rounded-3xl bg-gray-50 border border-gray-50 group hover:bg-white hover:shadow-xl transition-all">
                  <div className="h-12 w-12 rounded-full bg-white flex items-center justify-center text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 shadow-sm transition-all group-hover:bg-gradient-to-r from-purple-600 to-orange-600 group-hover:text-white">
                ...
                <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="space-y-6">
                  {sent ? (
                    <div className="py-12 text-center flex flex-col items-center justify-center">
                      <div className="h-24 w-24 bg-gray-50 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 rounded-full flex items-center justify-center mb-8 border-4 border-white shadow-lg">
                      ...
                      <Button onClick={() => setSent(false)} className="rounded-full px-10 h-14 bg-[#581C87] hover:bg-gradient-to-r from-purple-600 to-orange-600 font-black text-white text-lg transition-all shadow-lg">
                        Send Another
                      </Button>
                    </div>
                  ) : (
                    <>
                      <div className="grid gap-6 sm:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input placeholder="Enter your full name" className="bg-gray-50 border-gray-50 focus-visible:ring-orange-600 h-14 rounded-2xl text-base px-6 shadow-inner" />
                        </div>
                        <div className="space-y-2">
                          <Label className="text-base text-[#581C87] font-black uppercase tracking-wider ml-1">Email Address</Label>
                          <Input type="email" placeholder="example@mail.com" className="bg-gray-50 border-gray-50 focus-visible:ring-orange-600 h-14 rounded-2xl text-base px-6 shadow-inner" />
                        </div>
                      </div>
                      <div className="space-y-2">
                        <Label className="text-base text-[#581C87] font-black uppercase tracking-wider ml-1">Subject</Label>
                        <Input placeholder="How can we help you?" className="bg-gray-50 border-gray-50 focus-visible:ring-orange-600 h-14 rounded-2xl text-base px-6 shadow-inner" />
                      </div>
                      <div className="space-y-2">
                        <Label className="text-base text-[#581C87] font-black uppercase tracking-wider ml-1">Your Message</Label>
                        <Textarea placeholder="Write your message here..." rows={5} className="bg-gray-50 border-gray-50 focus-visible:ring-orange-600 rounded-2xl text-base px-6 py-4 shadow-inner resize-none" />
                      </div>
                      <Button className="w-full bg-[#581C87] hover:bg-gradient-to-r from-purple-600 to-orange-600 text-white font-black h-16 rounded-2xl text-xl shadow-[0_10px_20px_rgba(88,28,135,0.2)] hover:shadow-[0_15px_30px_rgba(194,65,12,0.3)] transition-all uppercase tracking-tight flex items-center justify-center gap-3" type="submit">
      ...
      <section className="py-16 bg-[#581C87] text-white text-center">
        <div className="w-full px-6">
          ...
          <Button size="lg" className="rounded-full h-14 px-12 bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-gradient-to-r from-purple-600 to-orange-600 text-white font-black text-lg shadow-xl" asChild>
