                ...
                <div className="w-full px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {modules.map((mod, i) => (
                            <div
                                key={i}
                                className="group relative bg-white p-8 rounded-[40px] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-gray-50 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden flex flex-col h-full"
                            >
                                {/* Background Accent */}
                                ...
                                <div className="relative mb-8">
                                    ...
                                    {/* Floating Dot */}
                                    <div className={`absolute -bottom-1 -left-1 w-4 h-4 bg-white rounded-full border-4 border-gray-50 shadow-sm`}></div>
                                </div>
