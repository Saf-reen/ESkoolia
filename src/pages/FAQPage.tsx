        ...
        <div className="bg-white min-h-screen">
            ...
            <section className="py-16 lg:py-24 bg-white border-b border-gray-50">
                <div className="w-full px-6 text-center">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-bold tracking-widest uppercase text-xs mb-3 block">Support Center</span>
                    <h2 className="font-display text-4xl lg:text-6xl font-black text-[#581C87] mb-8 uppercase tracking-tighter">
                        Questions & <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600">Answers</span>
                    </h2>
                    <div className="max-w-3xl mx-auto relative group">
                        <Search className="absolute left-6 top-1/2 -translate-y-1/2 text-[#581C87]/70 h-6 w-6 group-focus-within:text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 transition-colors" />
                        <input
                            type="text"
                            placeholder="Search your question here..."
                            value={searchQuery}
                            onChange={(e) => setSearchQuery(e.target.value)}
                            className="w-full h-16 pl-16 pr-8 rounded-full border-2 border-gray-50 focus:border-orange-600 outline-none text-lg font-medium shadow-sm transition-all focus:shadow-xl"
                        />
                    </div>
                    <p className="mt-8 text-[#581C87]/60 font-medium">
                        Can't find what you're looking for? <a href="/contact" className="text-[#581C87] hover:text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-bold underline transition-colors">Contact us</a>
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            <div className="bg-[#581C87] p-8 rounded-[40px] text-white relative overflow-hidden group shadow-2xl">
                                <HelpCircle className="h-12 w-12 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 mb-6" />
                                ...
                                <Button className="w-full h-14 bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-gradient-to-r from-purple-600 to-orange-600 text-white font-black rounded-2xl shadow-lg transition-all" asChild>
                            ...
                            <div className="bg-gray-50 p-8 rounded-[40px] border border-gray-50">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        ...
                                        <li key={i}>
                                            <a href={link.href} className="text-[#581C87]/70 hover:text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-bold flex items-center transition-colors">
                                                <span className="w-2 h-2 bg-gradient-to-r from-purple-600 to-orange-600 rounded-full mr-3"></span>
                                                {link.label}
                                            </a>
                                        </li>
                                    ))}
