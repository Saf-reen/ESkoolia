        ...
        <div className="container">
          <div className="mx-auto max-w-5xl space-y-20">
            ...
            <div>
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                {[
                  ...
                  { icon: Building2, title: "Multi Branch System", desc: "Manage unlimited schools and branches from a single super-admin dashboard.", color: "text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600", bg: "bg-gradient-to-r from-purple-600 to-orange-50" },
                  ...
                  { icon: Server, title: "Self-Hosted Control", desc: "Deploy on your own servers (AWS, DigitalOcean, etc). You own your data.", color: "text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600", bg: "bg-gradient-to-r from-purple-600 to-orange-50" },
                ].map((item) => (
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={r} className="flex items-center gap-3 text-[#581C87]/80 font-medium">
                        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-purple-600 to-orange-600/10 flex items-center justify-center shrink-0">
                          <CheckCircle2 className="h-3.5 w-3.5 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600" />
                        </div>
                        {r}
                      </li>
                    ))}
                  ...
                  <div className="relative bg-white p-6 rounded-2xl shadow-lg border border-gray-50">
                    <div className="flex items-center gap-4 mb-4 border-b border-gray-50 pb-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-bold flex items-center gap-1"><span className="h-2 w-2 bg-gradient-to-r from-purple-600 to-orange-600 rounded-full animate-pulse"></span> Online</div>
                      </div>
                    </div>
              ...
              <div className="rounded-3xl border border-gray-50 bg-white p-8 shadow-lg">
                <div className="grid gap-8 sm:grid-cols-3 text-center divide-y sm:divide-y-0 sm:divide-x divide-gray-50">
                  <div className="pt-4 sm:pt-0">
                    <TrendingUp className="h-8 w-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 mx-auto mb-3" />
                  ...
                  <div className="pt-8 sm:pt-0">
                    <IndianRupee className="h-8 w-8 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 mx-auto mb-3" />
            ...
            <div className="relative rounded-3xl border-2 border-[#581C87] bg-white p-12 text-center shadow-2xl overflow-hidden group">
              ...
              <Button size="lg" aria-label="Book a demo for enterprise" className="h-14 px-8 text-lg font-bold bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-gradient-to-r from-purple-600 to-orange-600 border-none shadow-lg hover:shadow-xl transition-all" asChild>
                <Link to="/contact">Book a Demo <ArrowRight className="ml-2 h-5 w-5" /></Link>
              </Button>
