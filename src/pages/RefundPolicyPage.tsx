            ...
            <div className="container mx-auto px-4 py-16">
                ...
                <div className="max-w-4xl mx-auto mb-16 text-center">
                    <p className="text-[#276221]/70 leading-relaxed text-lg">
                        At <span className="font-bold text-[#276221]">eSkoolia</span>, we want you to be completely satisfied with our software. This Refund Policy outlines the terms and conditions for requesting a refund.
                    </p>
                </div>
