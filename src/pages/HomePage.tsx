...
const stats = [
  ...
  { label: "South America", value: "6.8%", color: "bg-green-500", position: "bottom-[20%] left-[20%]" },
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section
        className="relative overflow-hidden pb-20 pt-32 lg:pt-40 bg-white min-h-screen flex flex-col items-center justify-center cursor-green-section"
      >
        {/* Subtle background glows */}
        <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-orange-500/5 rounded-full blur-[100px] pointer-events-none"></div>
        <div className="absolute bottom-[-10%] left-[-5%] w-[600px] h-[600px] bg-[#276221]/5 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <div className="w-full relative z-10 px-6 lg:px-12 xl:px-16 2xl:px-24">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full max-w-[1800px] mx-auto">
            ...
            <motion.div
              ...
              className="text-left"
            >
              <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-orange-50 text-orange-600 font-bold text-sm tracking-wide mb-8 border border-orange-200 shadow-sm">
                <MapPin className="w-3.5 h-3.5" />
                Serving Tier 2 & Tier 3 Schools in Telangana
              </div>
              <h1 className="mb-6 font-display text-5xl font-extrabold leading-[1.1] tracking-tight sm:text-6xl lg:text-7xl text-[#276221]">
                ...
                <span className="relative inline-block mt-2 min-h-[1.1em] text-orange-500">
                  ...
                  <span className="absolute bottom-2 left-0 w-full h-2 bg-orange-500/20 rounded-full"></span>
                  <span className="inline-block w-[3px] h-[40px] md:h-[50px] bg-[#276221] ml-2 align-middle -mt-2 animate-pulse"></span>
                </span>
              </h1>

              <p className="text-xl md:text-2xl text-[#276221]/80 max-w-xl mb-6 font-medium leading-relaxed">
              ...
              <p className="text-lg md:text-xl text-orange-500 font-semibold mb-10 max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-center sm:justify-start">
                <Button size="lg" className="rounded-full w-full sm:w-auto h-14 px-10 text-lg shadow-[0_15px_30px_rgba(249,115,22,0.25)] transition-all font-bold bg-orange-500 text-white hover:bg-[#276221] border-none transform hover:-translate-y-1" asChild>
                ...
                >
                  <div className="flex items-center justify-center w-14 h-14 rounded-full border border-gray-200 group-hover:border-orange-200 group-hover:bg-orange-50 transition-all mr-4 bg-white shadow-sm">
                    <Play className="w-5 h-5 fill-orange-500 text-orange-500 ml-1" />
                  </div>
                  <span className="text-xl font-bold tracking-tight text-[#276221] group-hover:text-orange-500 transition-colors">
                    Watch the Vision
                  </span>
                </div>
                {showVideo && (
            ...
            >
              <div className="relative z-10 transform hover:scale-[1.02] transition-transform duration-700 drop-shadow-[0_20px_40px_rgba(39,98,33,0.2)]">
                <img src='/erp.png' alt="Eskoolia Dashboard" className="w-auto h-100 object-contain" />
              </div>

              {/* Accenting glow below image */}
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-[90%] h-16 bg-[#276221]/20 blur-[40px] -z-10"></div>
              ...
              <div className="absolute -left-6 top-1/4 bg-white p-3 rounded-2xl shadow-xl border border-gray-100 hidden md:flex items-center gap-3 animate-float z-20" style={{ animationDelay: '100ms' }}>
                <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center"><CheckCircle2 className="w-5 h-5 text-[#276221]" /></div>
                <div>
                  <div className="text-sm font-bold text-[#276221]">Auto Setup</div>
                  <div className="text-xs text-[#276221]/60 font-medium">100% Ready</div>
                </div>
              </div>
              ...
              <div className="absolute -right-6 bottom-1/4 bg-white p-3 rounded-2xl shadow-xl border border-gray-100 hidden md:flex items-center gap-3 animate-float z-20" style={{ animationDelay: '300ms' }}>
                <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center"><Zap className="w-5 h-5 text-orange-500" /></div>
                <div>
                  <div className="text-sm font-bold text-[#276221]">Fast Sync</div>
                  <div className="text-xs text-[#276221]/60 font-medium">Real-time</div>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="relative -mt-10 z-20 pb-20">
        <div className="container px-4">
          <div className="bg-white/90 backdrop-blur-xl rounded-[32px] shadow-lg p-8 md:p-10 flex flex-col md:flex-row justify-around items-center gap-10 border border-green-100 max-w-6xl mx-auto">

            {/* Users */}
            <div className="flex flex-col items-center gap-2 text-center">
              <div className="text-5xl font-extrabold text-[#276221]">15k+</div>
              <div className="text-[#276221]/60 text-sm">Global Users</div>
            </div>

            {/* Countries */}
            <div className="flex flex-col items-center gap-2 text-center">
              <div className="text-5xl font-extrabold text-[#276221]">90+</div>
              <div className="text-[#276221]/60 text-sm">Countries</div>
            </div>

            {/* Satisfaction */}
            <div className="flex flex-col items-center gap-2 text-center">
              <div className="text-5xl font-extrabold text-[#276221]">95%</div>
              <div className="text-[#276221]/60 text-sm">Satisfaction Rate</div>
            </div>
      ...
      {/* Problems Section */}
      {/* Problems Section */}
      <section className="relative py-28 lg:py-36 bg-gradient-to-b from-white via-green-50/40 to-orange-50/40 overflow-hidden">

        {/* Background Glow */}
        <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-orange-500/10 rounded-full blur-[140px]"></div>
        <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-[#276221]/10 rounded-full blur-[140px]"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <span className="text-orange-500 font-bold uppercase tracking-[0.25em] text-xs mb-4 block">
              Why Sria Infotech
            </span>

            <h2 className="font-display text-4xl md:text-6xl font-extrabold text-[#276221] leading-[1.1]">
              Traditional School Management is
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-green-700">
                Broken
              </span>
            </h2>
            ...
            <div className="mt-10 relative max-w-3xl mx-auto">
              ...
              <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-orange-500 to-green-700 rounded-full"></div>

              <div className="ml-6 bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg border border-gray-100 p-6 md:p-8">
                <p className="text-lg md:text-xl text-[#276221]/80 font-semibold leading-relaxed italic">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-12">
              {[
                ...
                <span
                  key={idx}
                  className="px-5 py-2.5 bg-white border border-gray-100 rounded-full text-sm font-semibold text-orange-500 shadow-sm hover:shadow-md transition"
                >
                  {item}
                </span>
              ))}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            {[
              ...
              >
                ...
                {/* Icon */}
                <div className="w-16 h-16 flex items-center justify-center rounded-xl bg-[#276221] text-white mb-6 group-hover:bg-orange-500 transition">
                  <item.icon className="w-8 h-8" />
                </div>

                {/* Title */}
                <h3 className="text-2xl font-bold text-[#276221] mb-3">
                  {item.title}
                </h3>

                {/* Description */}
                <p className="text-[#276221]/70 leading-relaxed">
                  {item.desc}
                </p>
      ...
      {/* 4. 3 Core Solutions */}
      <section className="py-24 lg:py-32 bg-gradient-to-b from-white to-green-50 relative overflow-hidden group/section">
        {/* Soft center glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-green-600/5 rounded-full blur-[120px] pointer-events-none transition-all duration-1000 group-hover/section:bg-green-600/10 hover:scale-110 transform"></div>

        <div className="container px-6 relative z-10">
          <div className="text-center mb-24">
            <span className="text-orange-500 font-black uppercase tracking-[0.2em] text-sm mb-4 block">Local Advantage</span>
            <h2 className="font-display text-4xl md:text-6xl font-black text-[#276221] mb-6 leading-[1.1] uppercase max-w-4xl mx-auto tracking-tight">
              Why Sria Infotech? <br className="hidden md:block" />We Are Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-green-700">Local Technology Partner.</span>
            </h2>
            <div className="w-24 h-1.5 bg-gradient-to-r from-orange-500 to-green-700 mx-auto rounded-full mb-8 opacity-80"></div>
            <p className="text-xl text-[#276221]/70 font-medium leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-10 max-w-7xl mx-auto group/cards">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.15, duration: 0.6 }}
                className="group flex flex-col bg-white rounded-[40px] border border-green-100 shadow-xl hover:shadow-[0_40px_80px_rgba(88,28,135,0.12)] hover:-translate-y-2 transition-all duration-500 relative overflow-hidden hover:opacity-100 opacity-100 lg:group-hover/cards:opacity-70"
              >
                {/* Top Gradient Strip */}
                <div className="h-2 w-full bg-gradient-to-r from-green-700 to-orange-500"></div>

                {/* Large faint number */}
                <div className="absolute top-8 right-6 text-8xl md:text-9xl font-black text-[#276221] opacity-[0.03] pointer-events-none select-none transition-all duration-500 group-hover:scale-110 group-hover:text-orange-500 group-hover:opacity-[0.05]">
                  0{i + 1}
                </div>

                <div className="p-10 flex flex-col flex-1 relative z-10">
                  <span className="text-green-700 font-black uppercase tracking-widest text-xs md:text-sm mb-2">{sol.title.substring(3)}</span>
                  <h3 className="text-3xl font-black text-[#276221] mb-4 uppercase tracking-tight">{sol.subtitle}</h3>
                  <div className="w-12 h-1 bg-green-100 mb-8 rounded-full group-hover:bg-orange-500 group-hover:w-20 transition-all duration-500"></div>

                  <p className="text-[#276221]/70 text-lg leading-relaxed mb-10 min-h-[80px]">{sol.desc}</p>

                  <div className="space-y-3 mb-12 flex-1 relative">
                    {sol.benefits.map((b, idx) => (
                      <div key={idx} className="flex gap-4 items-center bg-green-50 rounded-2xl p-4 group-hover:bg-orange-50 transition-colors duration-300 border border-transparent group-hover:border-orange-100">
                        ...
                        <span className="font-bold text-[#276221] text-sm md:text-base leading-tight">{b}</span>
                      </div>
                    ))}
                  </div>

                  <Button className="w-full rounded-full h-14 bg-gradient-to-r from-[#276221] to-green-700 hover:from-orange-500 hover:to-orange-600 text-white font-black text-lg shadow-lg hover:shadow-[0_15px_40px_rgba(249,115,22,0.4)] transition-all duration-500 uppercase tracking-tight transform group-hover:scale-[1.03] border-none" asChild>
        ...
        {/* Soft Divider */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-green-200 to-transparent opacity-50"></div>
      </section>

      {/* 5. Outcome-Driven Benefits Content */}
      <section className="py-24 lg:py-40 bg-[#276221] text-white overflow-hidden relative cursor-green-section">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative">
              <div className="relative z-10 space-y-6 transform translate-x-10">
                ...
                >
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-[#276221] rounded-full flex items-center justify-center text-white shadow-lg">
                  ...
                  <div className="h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full w-[65%] bg-[#276221]"></div>
                  </div>
                </motion.div>
              </div>
      ...
      <section className="py-28 bg-gradient-to-b from-white to-gray-50" id="pricing">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#276221] mb-8 leading-[1.1] tracking-tight">
              The Real Challenges <br className="hidden md:block" />
              Facing Your School Today
            </h2>
            <p className="text-lg md:text-xl text-[#276221]/70 font-medium leading-relaxed max-w-2xl mx-auto mb-12">
              Traditional systems slow down growth. Eskoolia modernizes your school from the ground up.
            </p>
          </div>

          {/* Early Bird Card */}
          <div className="max-w-5xl mx-auto bg-white rounded-[32px] shadow-[0_20px_60px_rgba(88,28,135,0.06)] border border-green-100 p-10 md:p-14 mb-24 relative hover:shadow-[0_30px_80px_rgba(88,28,135,0.1)] transition-all duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="mt-4 flex items-end gap-4">
                  <h3 className="text-5xl font-extrabold text-[#276221] tracking-tight">
                    ₹49,999
                  </h3>
                  <span className="text-[#276221]/70 line-through text-xl">
                    ₹67,500
                  </span>
                </div>

                <p className="mt-3 text-sm text-[#276221]/70">
                  One-time setup fee. Includes 26% discount.
                </p>

                <Button
                  size="lg"
                  className="mt-8 bg-orange-500 hover:bg-[#276221] text-white rounded-full px-10 h-14 font-bold shadow-lg"
                  asChild
                >
                  <Link to="/contact">
                    Claim Your Slot Now
              ...
              {/* Features */}
              <div>
                <p className="font-bold uppercase text-xs tracking-[0.2em] text-[#276221]/70 mb-6">
                  What You Get
                </p>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={idx} className="flex items-center gap-3 text-[#276221] font-medium">
          ...
          {/* <div className="bg-white rounded-3xl border border-gray-50 p-10 text-center shadow-lg hover:shadow-xl transition">
              <h3 className="text-2xl font-bold text-[#276221]">Standard</h3>
              <p className="mt-6 text-4xl font-extrabold text-[#276221]">₹67</p>
              <p className="text-sm text-[#276221]/60">Lifetime</p>

              <ul className="mt-8 space-y-3 text-[#276221]/70 font-medium">
              ...
              <Button className="mt-8 w-full rounded-full bg-[#276221] text-white hover:bg-orange-500 h-12" asChild>
                <Link to="/pricing">Buy Now</Link>
              </Button>
            </div> */}

          {/* Premium (Highlighted) */}
          {/* <div className="bg-[#276221] text-white rounded-3xl p-12 text-center shadow-2xl scale-105 relative">
              ...
              <Button className="mt-10 w-full rounded-full bg-white text-[#276221] hover:bg-orange-500 hover:text-white h-14 font-bold" asChild>
                <Link to="/pricing">Buy Now</Link>
              </Button>
            </div> */}
          ...
          {/* Business */}
          {/* <div className="bg-white rounded-3xl border border-gray-50 p-10 text-center shadow-lg hover:shadow-xl transition">
              <h3 className="text-2xl font-bold text-[#276221]">Business</h3>
              <p className="mt-6 text-4xl font-extrabold text-[#276221]">₹999</p>
              <p className="text-sm text-[#276221]/60">Lifetime</p>
        ...
        <div className="container px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:pr-12 text-center lg:text-left">
              ...
              <h2 className="font-display text-3xl md:text-5xl lg:text-6xl font-extrabold text-[#276221] mb-8 leading-[1.1] tracking-tight">
                Trusted by <br />
              ...
              <p className="text-lg md:text-xl text-[#276221]/70 font-medium leading-relaxed max-w-xl mb-12 mx-auto lg:mx-0">
              ...
              <div className="flex justify-center lg:justify-start items-center gap-6">
                ...
                <div className="text-[#276221] font-black uppercase tracking-wider text-sm">
                  Join the Elite 1%
                </div>
              </div>
            </div>
            ...
            <div className="relative w-full max-w-full overflow-hidden">
              ...
              >
                    ...
                    <CarouselItem key={index} className="basis-full">
                      <div className="p-2">
                        <div className="bg-gray-50 p-6 md:p-10 rounded-3xl md:rounded-[48px] border border-gray-100 shadow-sm min-h-[250px] md:min-h-[350px] flex flex-col justify-center relative overflow-hidden">
                          ...
                          <div className="absolute top-6 right-6 md:top-8 md:right-8 text-[#276221]/10">
                          ...
                          <p className="text-base md:text-xl text-[#276221] font-semibold italic leading-relaxed mb-6 md:mb-8">
                            "{t.text}"
                          </p>

                          <div className="flex items-center gap-3">
                            <div className="w-1 h-6 md:h-8 bg-orange-500 rounded-full"></div>
                            <div className="text-[#276221] font-black uppercase tracking-widest text-xs">
                ...
                <div className="flex justify-center lg:justify-start gap-4 mt-6 md:mt-10">
                  <CarouselPrevious className="static translate-y-0 h-10 w-10 md:h-14 md:w-14 bg-[#276221] text-white hover:bg-orange-500 border-none shadow-lg" />
                  <CarouselNext className="static translate-y-0 h-10 w-10 md:h-14 md:w-14 bg-[#276221] text-white hover:bg-orange-500 border-none shadow-lg" />
                </div>
      ...
      <section className="relative py-16 lg:py-24 bg-gradient-to-b from-[#276221] to-[#276221] text-white overflow-hidden cursor-green-section">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mb-16">
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full h-16 px-12 border border-white/30 bg-white/5 hover:bg-white hover:text-[#276221] font-bold text-lg backdrop-blur-lg transition-all duration-300"
              asChild
            >
              <a
      ...
      <section className="bg-[#e8fcf3] py-28">
          ...
          <div className="grid lg:grid-cols-12 gap-20">
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-28">
                ...
                {/* Description */}
                <p className="text-xl text-[#276221]/70 font-medium leading-relaxed mb-12">
                ...
                <Button
                  variant="outline"
                  className="mt-10 rounded-full px-8 h-12 border border-[#276221] text-[#276221] hover:bg-[#276221] hover:text-white transition-all"
                  asChild
                >
                  <Link to="/faq">
            ...
            <div className="lg:col-span-8">
              <Accordion type="single" collapsible className="space-y-5">
                ...
                {faqs.slice(0, 5).map((faq, i) => (
                  ...
                  >
                    <AccordionTrigger className="text-lg lg:text-xl font-semibold text-[#276221] text-left hover:no-underline">
                      {faq.q}
                    </AccordionTrigger>

                    <AccordionContent className="mt-4 text-base text-[#276221]/70 leading-relaxed">
                      {faq.a}
                    </AccordionContent>
                  </AccordionItem>
                ))}
        ...
        <div className="container px-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-700 mb-12">
            <div className="flex items-center gap-4">
              <Shield className="w-8 h-8 text-[#276221]" />
              <span className="font-black uppercase tracking-[0.2em] text-xs text-[#276221]">Bank-Grade Security</span>
            </div>
            <div className="flex items-center gap-4">
              <BadgeCheck className="w-8 h-8 text-[#276221]" />
              <span className="font-black uppercase tracking-[0.2em] text-xs text-[#276221]">99.9% Uptime Commitment</span>
            </div>
            <div className="flex items-center gap-4">
              <Map className="w-8 h-8 text-[#276221]" />
              <span className="font-black uppercase tracking-[0.2em] text-xs text-[#276221]">Global Education Standard</span>
            </div>
          </div>

          <div className="max-w-4xl mx-auto text-center border-t border-gray-50 pt-10">
            <p className="text-[#276221] font-black uppercase tracking-[0.15em] text-sm mb-2">
              Eskoolia is a product of Sria Infotech Pvt Ltd, Hyderabad.
            </p>
            <p className="text-[#276221]/60 font-bold text-xs uppercase tracking-[0.1em]">
