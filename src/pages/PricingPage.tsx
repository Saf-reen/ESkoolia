        ...
        <div className="container">
          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-4xl mx-auto mb-16 mt-8">
              <div className="bg-gradient-to-r from-purple-600 to-orange-600 p-1 rounded-[32px] shadow-xl">
                <div className="bg-white rounded-[31px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 text-left">
                  <div className="flex-1">
                    <span className="inline-block px-4 py-1.5 rounded-full bg-gradient-to-r from-purple-600 to-orange-600/10 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-black text-xs uppercase tracking-widest mb-4">Limited Time Offer</span>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {[
                        ...
                        <div key={idx} className="flex gap-2 items-center">
                          <CheckCircle2 className="w-4 h-4 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600" />
                  ...
                  <div className="shrink-0 text-center md:text-right border-t md:border-t-0 md:border-l border-gray-50 pt-8 md:pt-0 md:pl-12">
                    ...
                    <div className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600 font-black uppercase tracking-widest text-sm mb-6">26% DISCOUNT INCLUDED</div>
                    <Button size="lg" className="rounded-full bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-[#581C87] text-white font-black px-10 h-14 uppercase tracking-wider" asChild>
          ...
          {/* <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-3">
            {plans.map((plan) => (
              <div key={plan.name} className={`relative rounded-3xl p-8 flex flex-col transition-all duration-300 ${plan.highlighted ? "bg-white border-2 border-[#581C87] shadow-2xl scale-105 z-10" : "bg-white border border-gray-50 shadow-lg hover:shadow-xl"}`}>
                ...
                {plan.highlighted && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-gradient-to-r from-purple-600 to-orange-600 px-4 py-1 text-xs font-bold uppercase tracking-wider text-white shadow-md">Most Popular</div>
                )}
                ...
                <Button className={`mb-8 w-full font-bold h-12 text-md shadow-lg ${plan.highlighted ? "bg-gradient-to-r from-purple-600 to-orange-600 hover:bg-[#581C87] text-white border-0" : "bg-gray-50 hover:bg-[#581C87]/5 text-[#581C87] border border-gray-50 shadow-none hover:shadow-sm"}`} asChild>
                ...
                <div className="space-y-4 flex-1">
                  ...
                  {Object.entries(plan.features).map(([key, val]) => (
                    <div key={key} className="flex items-center justify-between text-sm py-1">
                      ...
                      {val === true ? (
                        <CheckCircle2 className="h-5 w-5 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-orange-600" />
                      ) : val === false ? (
